...
keywords: [quartic detection law, hidden variables, Fisher information, KL divergence, statistical manifold, cross-spectral geometry, information geometry]
include-in-header:
  - text: |
      <script type="application/ld+json">
      {
        ...
        "headline": "The Geometry of Invisible Forces: A Quartic Detection Theory",
        "author": {"@type": "Person", "name": "Yuda Bi", "url": "https://yudabitrends.github.io"},
        "datePublished": "2026-04-07",
        "description": "Why hidden variables are orders of magnitude harder to detect than classical statistics predicts — and how cross-spectral geometry breaks the impossibility.",
        "keywords": ["statistical physics", "information geometry", "hidden variables", "quartic detection law"],
        "url": "https://yudabitrends.github.io/notes/2026-04-quartic-detection-theory/"
      }
      </script>
      <meta name="citation_title" content="The Geometry of Invisible Forces: A Quartic Detection Theory">
...
1. **Yuda Bi**, Vince D. Calhoun. *Why Single Probes Cannot Detect Hidden Forcing: A Quartic Detection Law.* Under review at Physical Review Letters.

2. **Yuda Bi**, Vince D. Calhoun. *Cross Spectra Break the Single-Channel Impossibility.* Under review at Physical Review Letters.

3. **Yuda Bi**, Chenyu Zhang, Vince D. Calhoun. *Timescale Coalescence Makes Hidden Persistent Forcing Spectrally Dark.* Under review at Physical Review E. [arXiv:2603.20917](https://arxiv.org/abs/2603.20917)

4. **Yuda Bi**, Vince D. Calhoun. *Conditioning on a Volatility Proxy Compresses the Apparent Timescale of Collective Market Correlation.* Under review at Physical Review E. [arXiv:2603.14072](https://arxiv.org/abs/2603.14072)
